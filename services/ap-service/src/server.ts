...
import { apRouter } from "./controllers/ap.controller"
...
app.get("/health", (_, res) => res.json({ status: "ok", service: "ap-service", ts: new Date() }))
app.use(errorHandler)

app.listen(PORT, () => logger.info(`ap-service listening on :${PORT}`))
export default app
