...
app.get("/health", (_, res) => res.json({ status: "ok", service: "module-registry-service", ts: new Date() }))
app.use(errorHandler)

app.listen(PORT, () => logger.info(`module-registry-service listening on :${PORT}`))
export default app
